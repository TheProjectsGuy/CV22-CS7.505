# Helper utilities given with the original README
"""
...
if __name__ == "__main__":
    flo_file = "./../data/ground-truth-flow/RubberWhale/flow10.flo"
    max_thresh = 2e8    # No value beyond this
    # Read flow
    flow_original = read_flow(flo_file)
    flow = flow_original.copy()
    flow[flow > max_thresh] = 0
    # Show flow
    img_original = flow_to_image(flow_original)
    img = flow_to_image(flow)
    # Show flows
